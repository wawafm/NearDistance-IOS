...
- (NSArray *)postRequestWithURL: (NSString *)url  // IN
                    ...
                    finishblock:(finshuploadfileblock)block;  // IN
{
...
//    }];
    ...
    if([urlResponese statusCode] >=200&&[urlResponese statusCode]<300){
        NSArray *result=[NSJSONSerialization JSONObjectWithData:resultData options:NSJSONReadingMutableLeaves error:nil];
...
+ (NSString *)generateUuidString{
    ...
    // that you own
    NSString *uuidString = [NSString stringWithUTF8String:CFUUIDCreateString(kCFAllocatorDefault, uuid)];
