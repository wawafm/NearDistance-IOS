...
-(void)setup
{
    ...
    //0xe8e8e8
    contentView.backgroundColor = kUIColorFromRGB(WHITE);
    ...
    _msgLabel.font = FONG_14;
    _msgLabel.textAlignment = NSTextAlignmentCenter;
    _msgLabel.textColor = kUIColorFromRGB(BLACK_COLOR);
    ...
    //0xdadbdd
    lineView.backgroundColor = kUIColorFromRGB(LIGHTGRAY_COLOR);
    ...
    if(_buttonTitleList.count > 1)
    {
        ...
        lineView1.backgroundColor = kUIColorFromRGB(LIGHTGRAY_COLOR);
        [contentView addSubview:lineView1];
        
        NSString *formate_H = [NSString stringWithFormat:@"H:|-%f-[lineView1(%f)]",btnWidth,0.5f];
