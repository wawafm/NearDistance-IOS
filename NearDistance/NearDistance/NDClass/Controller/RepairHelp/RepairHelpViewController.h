...
@interface RepairHelpViewController : NDBaseViewController<UINavigationControllerDelegate,UIImagePickerControllerDelegate>
{
    NSData *imageData;
    UIImagePickerController *imagePickerController;
}
@property (nonatomic,retain) NSString *repairImgUrl;
